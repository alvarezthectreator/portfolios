...
export default function HeroSection({
  badge = "Hello there, I am Alvarez",
  titleLead = "Lead Software",
  titleAccent = "Engineer",
  titleTail = "Who Builds Trust",
  description = "I design and ship dependable backend systems, polished product experiences, and scalable engineering workflows that help teams move faster without sacrificing quality.",
  ...
  return (
    <div className="relative w-full overflow-hidden bg-zinc-950 font-sans text-white">
      ...
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.14),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(245,158,11,0.14),_transparent_25%)]" />
